...
- **WebSocket**: API key in connection URL and authentication message

## API Features

<CardGroup cols={2}>
  <Card title="Real-time Streaming" icon="wifi">
    WebSocket-based orderbook updates from 35+ exchanges with sub-second latency.
  </Card>
...
<Info>
  **35 Active Exchanges** • **40,747+ Trading Pairs** • **50GB Monthly Limit** • **Sub-second Latency** • **99.9% Uptime**
</Info>
