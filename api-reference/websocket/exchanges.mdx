...
```json
{
  ...
  "data": {
    "supported_exchanges": [
      "binance", "okx", "bybit", "kucoin", "gate", "mexc", 
      "bitget", "cryptocom", "huobi", "coinbase", "kraken"
    ],
    "active_exchanges": [
      "binance", "bybit", "kucoin", "gate", "mexc", 
      "bitget", "cryptocom", "huobi", "coinbase"
    ],
    "total_supported": 42,
    "total_active": 35,
    "exchange_status": {
...
<CardGroup cols={2}>
  ...
  <Card title="Bybit" icon="building-columns">
    **Status:** Active  
    **Pairs:** 1,800+  
    **Volume:** Leading derivatives exchange
  </Card>
  
  <Card title="KuCoin" icon="building-columns">
    **Status:** Active  
    **Pairs:** 2,200+  
    **Volume:** Wide altcoin selection
  </Card>
</CardGroup>

### Tier 2 Exchanges (High Volume)

- **Gate.io** - Comprehensive altcoin coverage
- **MEXC** - Emerging tokens and high volume
- **Bitget** - Copy trading and derivatives
- **Crypto.com** - Major retail exchange
- **Huobi Global** - Established global exchange
- **Coinbase Pro** - US-regulated exchange

### Tier 3 Exchanges (Medium Volume)

- **Kraken** - Security-focused exchange
- **Bitfinex** - Professional trading features
- **Gemini** - US-regulated, institutional focus
- **Bitstamp** - Established European exchange
