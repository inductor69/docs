...
api: "GET http://localhost:8000/api/v1/data-usage/{api_key}"
...
```bash cURL
curl "http://localhost:8000/api/v1/data-usage/demo_key_123"
```

```javascript JavaScript
const apiKey = 'demo_key_123';
const response = await fetch(`http://localhost:8000/api/v1/data-usage/${apiKey}`);
...
response = requests.get(f"http://localhost:8000/api/v1/data-usage/{api_key}")
